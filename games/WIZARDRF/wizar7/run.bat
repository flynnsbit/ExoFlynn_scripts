...
echo Click "Load"
echo.
if exist .\wizar6\*.bcf echo A Post-Ending save game has been found. 
if not exist .\wizar6\*.bcf echo A Post-Ending save game has *NOT* been found. 
...
rem :post
copy .\wizar6\*.bcf .\wizar7\
cls
echo.
if exist .\wizar7\*.bcf echo Copy Successful
if not exist .\wizar7\*.bcf echo Copy unsuccessful
echo.
pause
goto menu
